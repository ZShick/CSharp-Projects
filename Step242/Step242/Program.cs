...
class Program
{
    static void Main()
    {
        ...
        {
            Console.WriteLine("That number in spanish is " + stringArray[arrayNum] + ". Press Enter to continue.");
            Console.ReadLine();
            ...
            if (arrayNum1 >= 0 && arrayNum1 <= 4)
            {
                Console.WriteLine("The number at that location is " + intArray[arrayNum1] + ". Press Enter to continue.");
                Console.ReadLine();
